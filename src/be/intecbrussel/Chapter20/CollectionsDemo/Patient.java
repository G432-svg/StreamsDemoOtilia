...
//        return this.getTemperature()-o.getTemperature();
    ...
    public boolean equals(Object o) {
        ...
        if (getTemperature() != patient.getTemperature()) return false;
        if (isUnKnownVirus() != patient.isUnKnownVirus()) return false;
        if (isEnsured() != patient.isEnsured()) return false;
        if (getNationalRegistryNumber() != null ? !getNationalRegistryNumber().equals(patient.getNationalRegistryNumber()) : patient.getNationalRegistryNumber() != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = getNationalRegistryNumber() != null ? getNationalRegistryNumber().hashCode() : 0;
        result = 31 * result + (getFullName() != null ? getFullName().hashCode() : 0);
        result = 31 * result + getAge();
        result = 31 * result + getTemperature();
        result = 31 * result + (isUnKnownVirus() ? 1 : 0);
        result = 31 * result + (isEnsured() ? 1 : 0);
        return result;
    }
    @Override
